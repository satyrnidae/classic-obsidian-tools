...
public class CORecipeProvider extends RecipeProvider {
    public CORecipeProvider(DataGenerator arg) {
        super(arg);
    }
    ...
    protected void buildCraftingRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        {
            final @NotNull ResourceLocation obsidianAxeId = Objects.requireNonNull(
                    ForgeRegistries.ITEMS.getKey(COItems.OBSIDIAN_AXE.get()));
            ShapedRecipeBuilder.shaped(COItems.OBSIDIAN_AXE.get())
                    .group(obsidianAxeId.getPath())
                    .pattern("XX")
                    .pattern("X#")
                    .pattern(" #")
                    .define('X', Ingredient.of(COTags.Items.OBSIDIAN_CRAFTING_MATERIALS))
                    .define('#', Ingredient.of(COTags.Items.STICK_CRAFTING_MATERIALS))
                    .unlockedBy("has_obsidian", has(COTags.Items.OBSIDIAN_CRAFTING_MATERIALS))
                    .save(consumer, obsidianAxeId);
        }

        {
            final @NotNull ResourceLocation obsidianHoeId = Objects.requireNonNull(
                    ForgeRegistries.ITEMS.getKey(COItems.OBSIDIAN_HOE.get()));
            ShapedRecipeBuilder.shaped(COItems.OBSIDIAN_HOE.get())
...

        {
            final @NotNull ResourceLocation obsidianPickaxeId = Objects.requireNonNull(
                    ForgeRegistries.ITEMS.getKey(COItems.OBSIDIAN_PICKAXE.get()));
            ShapedRecipeBuilder.shaped(COItems.OBSIDIAN_PICKAXE.get())
...

        {
            final @NotNull ResourceLocation obsidianShovelId = Objects.requireNonNull(
                    ForgeRegistries.ITEMS.getKey(COItems.OBSIDIAN_SHOVEL.get()));
            ShapedRecipeBuilder.shaped(COItems.OBSIDIAN_SHOVEL.get())
...

        {
            final @NotNull ResourceLocation obsidianSwordId = Objects.requireNonNull(
                    ForgeRegistries.ITEMS.getKey(COItems.OBSIDIAN_SWORD.get()));
            ShapedRecipeBuilder.shaped(COItems.OBSIDIAN_SWORD.get())
