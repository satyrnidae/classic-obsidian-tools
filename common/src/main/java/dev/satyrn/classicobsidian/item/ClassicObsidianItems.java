...
import dev.satyrn.classicobsidian.mixin.DiggerItemAccessor;
import dev.satyrn.classicobsidian.mixin.ItemAccessor;
import net.minecraft.core.Registry;
import net.minecraft.world.item.*;

public class ClassicObsidianItems {
    private static final float OBSIDIAN_TOOL_SPEED = 1.05F;
    private static final int OBSIDIAN_TOOL_ENCHANTMENT_VALUE = 1;

    private static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ClassicObsidianCommon.MOD_ID,
    ...
    public static final RegistrySupplier<ShovelItem> OBSIDIAN_SHOVEL = ITEMS.register("obsidian_shovel", () -> {
        ...
        ((ItemAccessor)item).setMaxDamage(0);
        ((DiggerItemAccessor)item).setSpeed(OBSIDIAN_TOOL_SPEED);
        return item;
    });
